...
| Page | Contents |
|---|---|
| `index.html` | Hero (bio + two lab shots), research focus, four project cards, video, experience, education, 16 publications with search/filter, skills, lab gallery, contact |
